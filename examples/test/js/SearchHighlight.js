/**
 * SearchHighlight plugin for jQuery http://www.jquery.info/spip.php?article50
 * 
    ...
    buildReplaceTools : function(query) {
        ...
        switch(SearchHighlight.options.exact) {
          case "exact":
            ...
            break;
          case "whole":
            regex = '\\b\\w*('+regex+')\\w*\\b';http://www.jquery.info/spip.php?article50
            break;
        }    
        ...
        for(var startIndex=0,endIndex=el.childNodes.length;startIndex<endIndex;startIndex++) {
          ...
          if ( item.nodeType != 8 ) {//comment node
            ...
            if(item.nodeType==3) {
              ...
              //console.log("textNoAcc: ", textNoAcc);
              var newtext="",match,index=0;
              SearchHighlight.regex.lastIndex = 0;
              
            
              while(match = SearchHighlight.regex.exec(textNoAcc)) {
                //console.log( "hiliteTree1: " +text.substr(match.index,match[0].length));
